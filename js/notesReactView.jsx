(function() {
                 ...
                 <div id={note.id + "_p"} className={noteCls.join(' ')} onFocus={this.activate.bind(this, true)} onBlur={this.activate.bind(this, false)}>
                    <div className="shadow">
                        <div className="note_controls">
                            <div style="width: 70%;"><span className="time">{time}</span></div>
                           <div style="width: 30%;"><a className="button delete" onClick={fn.bind(this, note.id)} href="javascript:void(0)"><i className={cls}></i></a></div>
                        </div>
    ...
    var NoteFilter = React.createClass({
        ...
        render: function() {
            return (
                 <div id="searchbar">
                    <button  class="size2 s1-txt1 flex-c-m how-btn1 trans-04"></button>
                    <input id="searchfor" type="text" placeholder="Search Notes" onKeyUp={this.onKeyUp}/>
                </div>
            );
        },
