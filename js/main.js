...
//create a functions to push
			  ...
			  if (snapshot.exists()) {
				...
				// get comm name
					...
					var communitiesList = document.getElementById('communityName');
						...
						document.getElementById("nc").innerHTML="<button class='btn trigger_popup_fricc2 l1-txt1 wsize1 days' data-clipboard-text='http://newtabis.me/shareIt/index.html?nc="+ commName.val() +"' style='color:white;' >Share it.</button><span class='m1-txt1 p-b-2 m-l-15'> </span>"
	    ...
	    $(window).on('load',function () {
		   document.getElementById('newTabCounter').innerHTML = 'JOIN U1S <img src="./heartPink.png" style="width: 25px; height: 25px;margin-left: 15px;"> ';
